          ...
          <Center>
            <VStack>
              ...
              {products && products.length > 0 && <Table.Root size={"lg"} borderRadius={20} style={{width:'600px',  margin:'auto', marginBottom:'60px', marginTop:'40px', borderRadius:'20px', height:'90px', backgroundColor:'#494846'}}>
                          ...
                          <VStack style={{width:'1200px'}}>
                            <div style={{minWidth:'95%', backgroundColor:'#FFFFFF', height:'300px', borderRadius:'6px'}}>
                              <VStack> 
                                ...
                                <VStack style={{textAlign:'left', padding:'20px', fontSize:20, maxHeight:'220px', overflow:'scroll', scrollbarColor:'#000000', width:'45%'}}>
                                {currentCart.length > 0 && currentCart.map((v, i) => {
                                    if (currentCart.indexOf(v) !== i){
                                      return <></>
                                    }

                                    return <div style={{color:'white', left:'10px', marginLeft:'-39%', width:'300px'}}>
                            ...
                            <HStack>
                            <Table.Root size={"md"} borderRadius={20} style={{width:'200px',  margin:'auto', marginBottom:'60px', marginTop:'40px', borderRadius:'20px', height:'90px', backgroundColor:'#494846'}}>
                                  <Table.Header>
                                      <Table.Row style={{backgroundColor:'#494846', color:'white'}}>
                                      <Table.ColumnHeader style={{color:'white', fontWeight:600}}>Product Name</Table.ColumnHeader>
                                      <Table.ColumnHeader style={{color:'white', fontWeight:600}}>Quantity</Table.ColumnHeader>
                                  ...
                                  {currentCart.length > 0 && currentCart.map((v, i) => {
                                    ...
                                    return (<Table.Row><Table.Cell>{v.productName}</Table.Cell>
                                    <Table.Cell>{currentCart.filter((x) => {
                                     return v.productName == x.productName;
                                    }).length}</Table.Cell>
                                    ...
                                    <Table.Cell textAlign="end"><Button onClick={() => {
                                      ...
                                      setCurrentCart(o);
                                    }}>Remove One From Cart</Button></Table.Cell>
                                    </Table.Row>)
                                  })}
                                  </Table.Body>
                                  <Table.Footer>
                                    <p style={{width:'200px', padding:'10px'}}>Total: {cartTotalCost} points</p>
                                  </Table.Footer>
                          </Table.Root>
                          <VStack style={{margin:'10px'}}>
                          ...
                          <Button disabled={transactionStudent.balance - cartTotalCost < 0} onClick={() => {
                            let seenProducts:any[] = []
                          ...
                          <p style={{fontSize:18, width:'50%'}}>After this transaction, the student will have {transactionStudent.balance - cartTotalCost < 0 ? " less than zero " : transactionStudent.balance - cartTotalCost} points remaining</p>
                          </VStack>
